...
import {
    GET_ALL_RESTAURANTS_REQUEST, GET_ALL_RESTAURANTS_SUCCESS, GET_ALL_RESTAURANTS_FAILURE, GET_RESTAURANT_BY_ID_REQUEST,
    GET_RESTAURANT_BY_USER_ID_SUCCESS, GET_RESTAURANT_BY_USER_ID_FAILURE, GET_RESTAURANT_BY_USER_ID_REQUEST,
    GET_RESTAURANT_BY_ID_SUCCESS, GET_RESTAURANT_BY_ID_FAILURE,
...
export const getRestaurantByUserId = (jwt) => {
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("get restaurnat by user id", data)
